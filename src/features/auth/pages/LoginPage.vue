...
<template>
  <main class="relative h-screen w-full overflow-hidden">
    ...
    <section
      class="absolute left-[calc(50%-260px)] top-[calc(50%-180px)] z-10 w-[520px] rounded-[32px] bg-[#ecf0f350] p-8 shadow-[1px_1px_3px_#cbced1,-1px_-1px_3px_white] max-sm:left-4 max-sm:right-4 max-sm:top-[calc(50%-180px)] max-sm:w-auto"
    >
      <div class="flex flex-col gap-6">
        <h1
          class="text-center text-[32px] font-bold text-white [text-shadow:0_2px_4px_rgba(0,0,0,0.5)]"
        >
          登录
        </h1>
