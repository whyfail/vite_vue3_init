...
- Current runtime and dependency baseline: Node.js 24.18.0, pnpm 11.10.0, Vite 8.1.5, Vue 3.5.40, Vue Router 5.2.0, Pinia 4.0.2, TypeScript 6.0.3, Axios 1.18.1, Vue DevTools 8.1.5.
