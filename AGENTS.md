...
- Current runtime and dependency baseline: Node.js 24 LTS (>=24.11.0 <25), pnpm 11.20.0, Vite 8.3.0, Vue 3.5.42, Vue Router 5.3.1, Pinia 4.0.3, TypeScript 6.0.3, Axios 1.20.0, Vue DevTools 8.2.1.
